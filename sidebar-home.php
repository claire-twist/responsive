    ...
    <div id="widgets" class="home-widgets">
        ...
        <?php responsive_widgets(); // above widgets hook ?>
            ...
            <div class="widget-wrapper">
                ...
                <div class="textwidget"><?php _e('This is your fourth home widget box. To edit please go to Appearance > Widgets and choose 6th widget from the top in area 6 called Home Widget 1. Title is also manageable from widgets as well.','responsive'); ?></div>
        ...
        <?php responsive_widgets(); // above widgets hook ?>
            ...
            <div class="widget-wrapper">
                ...
                <div class="textwidget"><?php _e('This is your fifth home widget box. To edit please go to Appearance > Widgets and choose 6th widget from the top in area 6 called Home Widget 1. Title is also manageable from widgets as well.','responsive'); ?></div>
        ...
        <?php responsive_widgets(); // above widgets hook ?>
            ...
            <div class="widget-wrapper">
                ...
                <div class="widget-title-home"><h3><?php _e('Home Widget 3', 'responsive'); ?></h3></div>
                <div class="textwidget"><?php _e('This is your last home widget box. To edit please go to Appearance > Widgets and choose 8th widget from the top in area 8 called Home Widget 3. Title is also manageable from widgets as well.','responsive'); ?></div>
